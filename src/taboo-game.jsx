...
const CARD_DATABASE = [
  ...
  { word: 'GARDEL', forbidden: ['TANGO', 'ZARZUELA', 'MI', 'BUENOS', 'MORFI'] },
  { word: 'BERGOGLIO', forbidden: ['PAPA', 'FRANCISCO', 'VATICANO', 'JESÚS', 'ARGENTINO'] },
  ...
  { word: 'FOLLAR', forbidden: ['COGER', 'PENETRAR', 'CAMA', 'GIMNASIO', 'SEXUAL'] },
  { word: 'PIJA', forbidden: ['PENE', 'VERGA', 'DURO', 'ERECCIÓN', 'PORONGA'] },
  { word: 'CONCHA', forbidden: ['VAGINA', 'CHOCHO', 'HÚMEDO', 'CLÍTORIS', 'LABIOS'] },
  { word: 'MAMADA', forbidden: ['FELACIÓN', 'BOQUETE', 'CHUPAR', 'SEMEN', 'GARGANTA'] },
  { word: 'CORRIDA', forbidden: ['EYACULAR', 'LECHE', 'SEMINAL', 'ORGASMO', 'EXPLOSIÓN'] },
  { word: 'CLÍTORIS', forbidden: ['PUNTITO', 'PLACER', 'ROZAR', 'VIBRADOR', 'Lamer'] },
  { word: 'ANAL', forbidden: ['CULO', 'SEXUAL', 'PENETRACIÓN', 'LUBRICANTE', 'DOLOR'] },
  { word: 'SADOMASO', forbidden: ['BDSM', 'AZOTES', 'ATAR', 'DOMINAR', 'SUMISO'] },
  { word: 'TRIO', forbidden: ['TRES', 'SEXUAL', 'MMF', 'FFM', 'COMPARTIR'] },
  { word: 'VIBRADOR', forbidden: ['JUGUETE', 'SEXUAL', 'BATERÍA', 'PENETRAR', 'ORGASMO'] },
  { word: 'LUBRICANTE', forbidden: ['SLIP', 'SEXO', 'HÚMEDO', 'GEL', 'FROTAR'] },
  { word: 'FISTING', forbidden: ['PUÑO', 'PENETRACIÓN', 'EXTREMO', 'RELAX', 'MANO'] },
  { word: 'SWINGER', forbidden: ['INTERCAMBIO', 'PAREJAS', 'CLUB', 'ORGÍA', 'LIBRE'] },
  { word: 'SQUIRT', forbidden: ['CHORRO', 'FEMENINO', 'ORGASMO', 'MOJADA', 'EYACULACIÓN'] },
